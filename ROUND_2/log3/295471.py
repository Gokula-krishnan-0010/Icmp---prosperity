...
class Trader:
    def __init__(self):
        # Use dynamic cold-start instead of hardcoding to safely handle random unseen testcases
    ...
    def run(self, state: TradingState):
        ...
        for item, depth in state.order_depths.items():
            ...
            if item == "ASH_COATED_OSMIUM":
                ...
                # Asymmetric inventory relief: pay the spread if we are dangerously near limits
